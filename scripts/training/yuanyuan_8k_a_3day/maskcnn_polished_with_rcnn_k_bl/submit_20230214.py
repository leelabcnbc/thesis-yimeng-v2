...
def main():
    script_dict = dict()
    for param_dict in explored_models_20230214().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+yuanyuan_8k_a_3day+maskcnn_polished_with_rcnn_k_bl+20230214'
    )
