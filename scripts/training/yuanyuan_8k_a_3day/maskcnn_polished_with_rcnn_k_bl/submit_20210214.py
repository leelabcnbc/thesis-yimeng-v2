...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    main_models_8k_generator_with_another_split,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in main_models_8k_generator_with_another_split(with_source=False):
    ...
    utils.submit(
        ...
        dirname_relative='scripts+yuanyuan_8k_a_3day+maskcnn_polished_with_rcnn_k_bl+20210214'
    )
