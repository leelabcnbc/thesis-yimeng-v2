...
from master_with_cb19 import master
...
""".strip()
# use val_test_every=100 instead of the default 50 as now dataset doubled.


def main():
    script_dict = dict()
    for param_dict in explored_models_20200515().generate():
        param_dict = encode_transfer_learning_cb19_params(param_dict)
    ...
    utils.submit(
        ...
        dirname_relative='scripts+yuanyuan_8k_a_3day+maskcnn_polished_with_rcnn_k_bl_with_cb19_20200515'
    )
