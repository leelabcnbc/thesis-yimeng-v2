...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import script_keygen
from thesis_v2.configs.model.tang_v1_models import explored_models_20220923
...
def main():
    script_dict = dict()
    for param_dict in explored_models_20220923(with_source=False):
    ...
    utils.submit(
        ...
        dirname_relative='scripts+tang_v1+maskcnn_polished_with_rcnn_k_bl+20220923'
    )
