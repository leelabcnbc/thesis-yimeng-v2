...
from thesis_v2.configs.model.tang_v1_models import explored_models_20220506
...
def main():
    script_dict = dict()
    for param_dict in explored_models_20220506().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+tang_v1+maskcnn_polished_with_rcnn_k_bl+20220506'
    )
