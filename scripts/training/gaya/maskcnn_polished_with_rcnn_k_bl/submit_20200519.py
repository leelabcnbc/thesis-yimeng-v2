...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200519_gaya().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+gaya+maskcnn_polished_with_rcnn_k_bl+20200519'
    )
