...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    explored_models_20200822_tang_generator,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200822_tang_generator():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+tang+maskcnn_polished_with_rcnn_k_bl+20200822'
    )
