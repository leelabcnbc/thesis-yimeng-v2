...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    ns2250_control_with_no_lateral_20210824,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in ns2250_control_with_no_lateral_20210824():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+tang+maskcnn_polished_with_rcnn_k_bl+20210824'
    )
