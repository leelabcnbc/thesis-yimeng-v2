...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    explored_multipath_models_20220210,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in explored_multipath_models_20220210().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+cb19+maskcnn_polished_with_rcnn_k_bl+20220210_multi'
    )
