...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    ablation_7_models_cb19_generator,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in ablation_7_models_cb19_generator(with_source=False):
        key_this = script_keygen(**param_dict)
        # assert len(param_dict) == 29
    ...
    utils.submit(
        ...
        dirname_relative='scripts+cb19+maskcnn_polished_with_rcnn_k_bl+20220228_ablation'
    )
