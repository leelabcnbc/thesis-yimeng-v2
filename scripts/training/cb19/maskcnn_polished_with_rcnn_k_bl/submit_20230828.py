...
def main():
    script_dict = dict()
    for param_dict in main_models_cb19_generator(False):
        param_dict = deepcopy(param_dict)
        param_dict['dataset_prefix'] = 'cb19_sec'
    ...
    utils.submit(
        ...
        dirname_relative='scripts+cb19+maskcnn_polished_with_rcnn_k_bl+20230828'
    )
