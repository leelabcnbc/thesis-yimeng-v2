...
def main():
    script_dict = dict()
    for param_dict in explored_models_cb19_sicheng().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+cb19+maskcnn_polished_with_rcnn_k_bl+sicheng'
    )
