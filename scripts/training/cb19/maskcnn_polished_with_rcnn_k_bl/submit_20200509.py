...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200509_cb19().generate():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+cb19+maskcnn_polished_with_rcnn_k_bl+20200509'
    )
