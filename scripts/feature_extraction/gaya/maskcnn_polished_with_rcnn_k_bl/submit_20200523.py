...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200523_gaya_feature_extraction_generator():
    ...
    utils.submit(
        ...
        dirname_relative='scripts+gaya+maskcnn_polished_with_rcnn_k_bl+20200523+feature_extraction'
    )
