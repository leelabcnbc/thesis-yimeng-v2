...
from thesis_v2.configs.model.maskcnn_polished_with_rcnn_k_bl import (
    explored_models_20200619_8k_feature_extraction_generator,
    script_keygen
)
...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200619_8k_feature_extraction_generator():
        ...
        script_dict[key_this] = utils.call_script_formatter(
            ...
            **param_dict, key_script=key_this,
            batch_key='yuanyuan_8k_a/20200619',
        )

    utils.submit(
        script_dict, 'maskcnn_like', 'standard', True,
        dirname_relative='scripts+yuanyuan_8k_a+maskcnn_polished_with_rcnn_k_bl+20200619+feature_extraction'
    )
