...
def main():
    script_dict = dict()
    for param_dict in explored_models_20200801_2_generator():
        assert param_dict['dataset_prefix'] == 'yuanyuan_8k_a_3day'
        assert param_dict['model_prefix'] == 'maskcnn_polished_with_rcnn_k_bl'
        assert param_dict['rcnn_acc_type'] in {'last', 'instant'}
    ...
    utils.submit(
        ...
        dirname_relative='scripts+yuanyuan_8k_a_3day_refactored+maskcnn_polished_with_rcnn_k_bl+20200801_2'
    )
