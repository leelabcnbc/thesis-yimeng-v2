"""a modification of
https://github.com/leelabcnbc/thesis-yimeng-v1/blob/master/results_ipynb/yuanyuan_8k_a_3day/maskcnn_polished_lite_local_pcn_explore.ipynb
...
from thesis_v1.models.maskcnn_polished_with_local_pcn.builder import (gen_maskcnn_polished_with_local_pcn, load_modules)
...
def gen_cnn_partial(input_size, n):
    return gen_maskcnn_polished_with_local_pcn(input_size, n,
...
def do_something(note):
    ...
    for seed in range(3):
        results.append(train_one(gen_cnn_partial, opt_config_partial,
                                 datasets_raw,
                                 key=f'debug/maskcnn_polished_with_local_pcn/v1_code/{note}/{seed}',
