...
def process_one_model(*, key_script, key, get_data_fn, global_vars):
    # load data set
    data = get_data_fn()
    # load model
...
def process_one_model_one_dataset(*, model, dataset_to_extract, dataset_name, key_script, global_vars):
...
def master_one_case(*, key_script, key, global_vars, get_data_fn):
