...
def type_check_wrapper(x, type_checker, keys_to_check):
    ...
    assert x.keys() == keys_to_check, f'{x.keys()} NOT EQUAL to {keys_to_check}'  # noqa: E501
    for k, v in x.items():
        ...
        if isinstance(checker_this, type):
            ...
            # https://stackoverflow.com/questions/624926/how-do-i-detect-whether-a-python-variable-is-a-function  # noqa: E501
